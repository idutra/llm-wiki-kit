...
> Exemplo: este arquivo é o `AGENTS.md` que a operação `init` copiou, sem nenhuma alteração do time.
> Um wiki real costuma acrescentar aqui as regras do seu domínio.
